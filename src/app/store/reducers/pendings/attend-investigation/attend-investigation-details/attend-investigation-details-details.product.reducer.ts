...
export const productDetailsReducer = createReducer(
  ...
  on(attendInvestigationAddProductActions.RESTORE_PRODUCT_DETAILS, (state) => ({
    ...initialProductsDetails(),
  })),
  ...
  on(attendInvestigationAddProductActions.SET_IS_ADD_PRODUCT, (state, {value}) => ({
    ...state,
    isAddProduct: value,
  })),
  on(attendInvestigationDetailsActions.SET_BRAND_FAMILY, (state, {brand, IdFamily}) => ({
    ...state,
    selectedTradeMark: brand,
    productDetails: {
      ...state.productDetails,
      IdMarcaFamilia: IdFamily,
    },
  })),
  ...
  on(attendInvestigationAddProductActions.GET_PRODUCT_DETAILS_SUCCESS, (state, {payload}) => ({
    ...state,
    ...payload,
  })),
  on(attendInvestigationAddProductActions.SET_VALUE_DROP, (state, {value, node, nodeSelected}) => ({
    ...state,
    productDetails: {
      ...state.productDetails,
      [node]: value.value,
  ...
  on(attendInvestigationAddProductActions.SET_VALUE_INPUT_PUBLICATIONS, (state, {value, node}) => ({
    ...state,
    productDetails: {
      ...state.productDetails,
      ProductoPublicacion: {
          ...
          productDetails: {
            ...
            ProductoEstandar:
              ...
              state.productDetails.ProductoEstandar?.IdProductoEstandar !== DEFAULT_UUID
                ? {...state.productDetails.ProductoEstandar, Activo: true}
                : initialStandarProduct(),
            ProductoLabware:
              state.productDetails.ProductoLabware &&
        ...
        return {
          ...
          productDetails: {
            ...
            ProductoReactivo:
              state.productDetails.ProductoReactivo &&
              state.productDetails.ProductoReactivo?.IdProductoReactivo !== DEFAULT_UUID
                ? {...state.productDetails.ProductoReactivo, Activo: true}
                : initialReactiverProduct(),
            ProductoDispositivoMedico:
              state.productDetails.ProductoDispositivoMedico &&
              state.productDetails.ProductoDispositivoMedico?.IdProductoDispositivoMedico !==
...
*/
  ...
  on(
    attendInvestigationAddProductActions.SET_SUCCESS_TYPE_PRODUCT_FAMILY,
    (state: ProductsDetails, {payload}): ProductsDetails => {
      ...
      const originalSelected: VMarcaFamilia = find(
        payload,
        (o: VMarcaFamilia) => o.IdMarcaFamilia === state.productDetails.IdMarcaFamilia,
      );
      return {
        ...state,
        productsTypeFamily: payload,
        productTypeFamilySelected: find(
          list,
          (o: DropListOption) => o.value === state.productDetails.IdMarcaFamilia,
        ),
        productDetails: {
          ...state.productDetails,
          Subtipo: originalSelected.Subtipo,
          Control: originalSelected.Control,
        },
      };
    },
  ),
  on(attendInvestigationAddProductActions.SET_CAS_VALUE, (state, {value}) => ({
    ...state,
    productDetails: {
      ...state.productDetails,
      Producto: {
  ...
  on(
    ...
    (state: ProductsDetails, {file}): ProductsDetails => {
      if (state.productDetails.Tipo === 'Estandares') {
        return {
          ...state,
          productDetails: {
            ...state.productDetails,
      ...
      } else if (state.productDetails.Tipo === 'Reactivos') {
        return {
          ...state,
          productDetails: {
            ...state.productDetails,
  ...
  on(
    attendInvestigationAddProductActions.SET_SUCCESS_CHARASTERISTIC_GROUPER,
    (state, {payload}) => ({
      ...state,
  ...
  on(
    attendInvestigationAddProductActions.SET_SAVE_PRODUCT_FAMILY_TYPE_SUCCESS,
  ...
  on(attendInvestigationAddProductActions.SET_VALIDATE_CAS_SUCCESS, (state, {value}) => ({
    ...state,
    validateCas: value,
  })),
  on(
    attendInvestigationAddProductActions.SET_SUPPLEMENTARY_PRODUCT_SUCCESS,
    (state, {payload}) => ({
      ...state,
      supplementaryProducts: payload,
    }),
  ),
  on(attendInvestigationAddProductActions.SET_NEW_PRODUCT_FILE, (state, {node, newFile}) => ({
    ...state,
    technicalCommercialInvestigationFiles: {
      ...state.technicalCommercialInvestigationFiles,
      [node]: newFile,
  ...
  on(attendInvestigationAddProductActions.SET_NEW_SUPPLEMENTS_PRODUCTS, (state) => ({
    ...state,
    supplementaryProducts: [...state.supplementaryProducts, state.supplement],
    supplement: initialISupplements(),
  })),

  on(attendInvestigationAddProductActions.SET_DELETE_SUPPLEMENT, (state, {payload}) => ({
    ...state,
  ...
  on(
    attendInvestigationAddProductActions.HANDLE_OPEN_ALERT_POP,
  ...
  on(
    ...
    (state, {value}): ProductsDetails => {
      const type = state.productDetails.Tipo;
      if (type === 'Estandares') {
        return {
          ...state,
          productDetails: {
  ...
  on(productLinkedActions.SET_SELECTED_SEARCH_TYPE, (state, {searchTypeSelected}) => ({
    ...
    linkedProducts: {
      ...
      queryInfo: {
        ...
        SortField: searchTypeSelected.value === '1' ? 'Descripcion' : 'CAS',
      },
    },
  })),
  on(
    ...
    (state, {list, totalResults}): ProductsDetails => {
      ...
      if (state.linkedProducts.tabSelected.id === '1') {
        if (state.productDetails.vProductoAlternativo.length > 0) {
          results = map(list, (o: Producto) => {
            if (
              find(
                state.productDetails.vProductoAlternativo,
                (p: VProductoAlternativo): boolean => p.IdProducto === o.IdProducto,
              )
            ) {
              return {
                ...o,
          ...
          results = map(list, (o: Producto) => {
            if (
              find(
                ...
                (p: VProductoComplementario): boolean => p.IdProducto === o.IdProducto,
              )
            ) {
              return {
                ...o,
  ...
  on(productLinkedActions.DISABLE_ALTERNATIVE_SUCCESS, (state, {response, IdProducto}) => ({
    ...
    productDetails: {
      ...
      vProductoAlternativo: filter(
        state.productDetails.vProductoAlternativo,
        (o: VProductoAlternativo) => o.IdProductoAlternativoRelacion !== response,
      ),
    },
    linkedProducts: {
      ...state.linkedProducts,
  ...
  on(productLinkedActions.DISABLE_COMPLEMENTARY_SUCCESS, (state, {response, IdProducto}) => ({
    ...
    productDetails: {
      ...
      vProductoComplementario: filter(
        state.productDetails.vProductoComplementario,
        (o: VProductoComplementario) => o.IdProductoComplementarioRelacion !== response,
      ),
    },
    linkedProducts: {
      ...state.linkedProducts,
  ...
  on(
    productDetailsActions.SET_TAB_OPTION,
    (state, {tabOption}): ProductsDetails => ({
      ...state,
      tabOption,
    }),
  ),
