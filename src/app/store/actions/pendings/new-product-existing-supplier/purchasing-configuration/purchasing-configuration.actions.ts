...
const typeReducer = 'Reducer - [Purchasing Configuration]';
...
export const SET_FAMILY_DETAILS_STATUS = createAction(
  buildingStringActionType(typeReducer, 'Set details familie status'),
  props<{status: number}>(),
);
