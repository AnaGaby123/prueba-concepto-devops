...
export const typeReducer = 'Attend Investigation Details Add Product';
...
export const SHOW_CONFIRM_DIALOG = createAction(
  buildingStringActionType(typeReducer, 'Discard or continue'),
);
...
export const SET_IS_ADD_PRODUCT = createAction(
  buildingStringActionType(typeReducer, 'Set is add product'),
  props<{value: boolean}>(),
);
export const HANDLE_OPEN_ALERT_POP = createAction(
  buildingStringActionType(typeReducer, 'Handle open alert pop'),
  props<{value: boolean}>(),
);
export const RESTORE_PRODUCT_DETAILS = createAction(
  buildingStringActionType(typeReducer, 'Restore product details'),
);
