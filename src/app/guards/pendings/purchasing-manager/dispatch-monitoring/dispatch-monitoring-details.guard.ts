...
import {selectAllowedToDetails} from '@appSelectors/pendings/purchasing-manager/dispatch-monitoring/dispatch-monitoring.selectors';
...
export class DispatchMonitoringDetailsGuard implements CanLoad {
