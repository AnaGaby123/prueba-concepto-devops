...
/* Selectors Imports */
import {selectAllowedToDetails} from '@appSelectors/pendings/purchasing-manager/confirm-dispatch/confirm-dispatch.selectors';
...
export class ConfirmDispatchGuard implements CanLoad {
