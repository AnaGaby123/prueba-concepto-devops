...
import {selectAllowToDetails} from '@appSelectors/pendings/purchasing-manager/register-confirmation/register-confirmation.selectors';
...
export class RegisterConfirmationDetailsGuard implements CanLoad {
