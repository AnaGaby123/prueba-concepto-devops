...
import {selectAllowedToDetails} from '@appSelectors/pendings/imports/plan-dispatch/plan-dispatch.selectors';
...
export class PlanDispatchDetailsGuard implements CanLoad {
