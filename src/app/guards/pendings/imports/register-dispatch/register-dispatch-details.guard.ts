...
import {selectAllowedToDetails} from '@appSelectors/pendings/imports/register-dispatch/register-dispatch.selectors';
...
export class RegisterDispatchDetailsGuard implements CanLoad {
