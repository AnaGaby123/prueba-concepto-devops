...
import {selectIsDetails} from '@appSelectors/pendings/charges/attend-review/attend-review.selectors';
...
export class AttendReviewDetailsGuard implements CanLoad {
