...
import {selectAllowedToDetails} from '@appSelectors/pendings/charges/execute-collection/execute-collection.selectors';
...
export class ExecuteCollectionDetailsGuard implements CanLoad {
