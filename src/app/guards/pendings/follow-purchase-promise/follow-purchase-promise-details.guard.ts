...
import {selectAllowedToDetails} from '@appSelectors/pendings/follow-purchase-promise/follow-purchase-promise.selectors';
...
export class FollowPurchasePromiseDetailsGuard implements CanLoad {
