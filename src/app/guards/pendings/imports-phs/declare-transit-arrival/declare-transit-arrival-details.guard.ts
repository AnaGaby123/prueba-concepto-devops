...
import {selectAllowedToDetails} from '@appSelectors/pendings/imports-phs/declare-transit-arrival/declare-transit-arrival.selectors';
...
export class DeclareTransitArrivalDetailsGuard implements CanLoad {
