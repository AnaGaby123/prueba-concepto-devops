...
import {OfferCharacteristicGrouperComponent} from '@appComponents/catalogos/providers/providers-details/sections/trademark-offer/offer/offer-classification/offer-characteristic-grouper.component';
...
import {FeatureGroupItemModule} from '@appComponents/catalogos/providers/providers-details/sections/trademark-offer/offer/offer-classification/feature-group-item/feature-group-item.module';
...
@NgModule({
  ...
  exports: [OfferCharacteristicGrouperComponent],
  imports: [
    CommonModule,
    TranslateModule,
    SearchModule,
...
export class OfferCharacteristicGrouperModule {}
