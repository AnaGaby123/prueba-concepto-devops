...
import {OfferClassificationComponent} from '@appComponents/catalogos/clients/clients-details/prices/offer-classification/offer-classification.component';
...
import {FeatureGroupItemModule} from '@appComponents/catalogos/clients/clients-details/prices/offer-classification/feature-group-item/feature-group-item.module';
...
@NgModule({
  ...
  exports: [OfferClassificationComponent],
  imports: [
    CommonModule,
    TranslateModule,
    SearchModule,
...
export class OfferClassificationModule {}
