...
import {TechnicalCommercialInvestigationRoutingModule} from '@appComponents/pendings/new-product-existing-supplier/attend-investigation/attend-investigation-details/product-details/technical-commercial-investigation/tech-commercial-invest-routing.module';
...
@NgModule({
  ...
  exports: [TechCommercialInvestigationComponent],
})
export class TechCommercialInvestigationModule {}
