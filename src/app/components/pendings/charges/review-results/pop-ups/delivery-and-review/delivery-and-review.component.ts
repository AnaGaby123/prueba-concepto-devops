...
@Component({
  selector: 'app-delivery-and-review',
  templateUrl: './delivery-and-review.component.html',
  styleUrls: ['./delivery-and-review.component.scss'],
})
export class DeliveryAndReviewComponent {
